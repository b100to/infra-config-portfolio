...
data "aws_security_group" "frontend_partner" {
  filter {
    name   = "group-name"
    values = ["cloud-partner-front-stage00000000000000000000000001"]
  }
}
...
#   filter {
#     name   = "group-name"
#     values = ["beacon-stage00000000000000000000000002"]
#   }
# }
data "aws_security_group" "backend_beacon" {
  filter {
    name   = "group-name"
    values = ["cloud-beacon-scan-stage00000000000000000000000001"]
  }
}
